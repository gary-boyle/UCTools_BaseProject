...
//         private SaveFileInfo_old[] _saveFiles = Array.Empty<SaveFileInfo_old>();
//         private SaveFileInfo_old _selectedSave;
...
//         {
//             var saveFilesList = new List<SaveFileInfo_old>();
...
//         {
//             var selectedSave = selectedItems.FirstOrDefault() as SaveFileInfo_old;
...
//                 
//                 // Update UI
//                 (_savesList.itemsSource as List<SaveFileInfo_old>).Clear();
//                 (_savesList.itemsSource as List<SaveFileInfo_old>).AddRange(_saveFiles);
//                 _savesList.Rebuild();
//                 
//                 // Update file count
...
//         }
//         
//         private async Task<SaveFileInfo_old[]> LoadSaveFilesDirectly()
//         {
//             var saveDirectory = Application.persistentDataPath + "/Saves/";
//             
//             if (!Directory.Exists(saveDirectory))
//             {
//                 return Array.Empty<SaveFileInfo_old>();
//             }
//             
//             var saveFiles = Directory.GetFiles(saveDirectory, "*.gamesave");
//             var saveInfos = new List<SaveFileInfo_old>();
//             
...
//                     var session = JsonUtility.FromJson<GameSessionData_old>(jsonContent);
//                     
//                     if (session != null)
//                     {
//                         var saveInfo = new SaveFileInfo_old(fileName, session);
...
//         }
//         
//         private async void LoadSelectedSave(SaveFileInfo_old saveInfoOld)
//         {
...
//             }
//             
//             SetStatus($"Loading {saveInfoOld.FileName}...", "info");
//             
...
//         }
//         
//         private async void DeleteSelectedSave(SaveFileInfo_old saveInfoOld)
//         {
//             var confirmed = EditorUtility.DisplayDialog(
//                 "Delete Save File",
//                 $"Are you sure you want to delete '{saveInfoOld.FileName}'?\n\nThis action cannot be undone.",
//                 "Delete",
//                 "Cancel"
//             );
//             
...
//             try
//             {
//                 SetStatus($"Deleting {saveInfoOld.FileName}...", "info");
//                 
//                 var filePath = GetSaveFilePath(saveInfoOld.FileName);
//                 if (File.Exists(filePath))
//                 {
//                     File.Delete(filePath);
//                     SetStatus($"Deleted {saveInfoOld.FileName}", "info");
//                 }
//                 
...
//         }
//         
//         private void ShowSaveFileInExplorer(SaveFileInfo_old saveInfoOld)
//         {
//             var filePath = GetSaveFilePath(saveInfoOld.FileName);
//             
//             if (File.Exists(filePath))
